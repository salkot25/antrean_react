...
class MainActivity : AppCompatActivity() {
    ...
    // Kiosk URL comes from build flavor (mobile/tv).
    private val kioskUrl = BuildConfig.KIOSK_URL
    private val kioskHost = Uri.parse(kioskUrl).host ?: "antrean.salkot.online"
